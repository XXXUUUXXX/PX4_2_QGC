...
public:
    ...
    Q_PROPERTY(Fact* BMS_quantity       READ BMS_quantity       CONSTANT)
    Q_PROPERTY(Fact* BMS_remaining      READ BMS_remaining      CONSTANT)
    //******************************************************************
    ...
    Fact* BMS_quantity              (void) { return &_BMS_quantityFact; }
    Fact* BMS_remaining             (void) { return &_BMS_remainingFact; }
    //******************************************************************
    ...
    static const char* _BMS_quantityFactName;
    static const char* _BMS_remainingFactName;
    //******************************************************************
    ...
    static const int    _BMS_quantityUnavailable;
    static const int    _BMS_remainingUnavailable;
    //******************************************************************
...
private:
    ...
    Fact            _BMS_quantityFact;
    Fact            _BMS_remainingFact;
    //******************************************************************
    Fact            _voltageFact;
...
public:
    ...
    //*****read_uart_sensor
    //Q_INVOKABLE void _handleReadUartSensor(mavlink_message_t& message);
...
private:
    ...
    void _handleDistanceSensor(mavlink_message_t& message);  //****distance_sensor
    void _handleReadUartSensor(mavlink_message_t &message);  //****read_uart_sensor
