...
//                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.current.value != -1) ? (_activeVehicle.battery.current.valueString + " " + _activeVehicle.battery.current.units) : "N/A" }
//                    // add BMS_voltage
                    QGCLabel {text: qsTr("BMS_voltage:") }
                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.BMS_voltage.value != -1) ? (_activeVehicle.battery.BMS_voltage.valueString + " " + "V") : "N/A" }
                    QGCLabel {text: qsTr("BMS_current:") }
                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.BMS_current.value != -1) ? (_activeVehicle.battery.BMS_current.valueString + " " + "A") : "N/A" }
                    QGCLabel {text: qsTr("BMS_temperature:") }
                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.BMS_temperature.value != -1) ? (_activeVehicle.battery.BMS_temperature.valueString + " " + "℃") : "N/A" }
                    QGCLabel {text: qsTr("BMS_quantity:") }
                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.BMS_quantity.value != -1) ? (_activeVehicle.battery.BMS_quantity.valueString + " " + "%") : "N/A" }
                    QGCLabel {text: qsTr("BMS_remaining:") }
                    QGCLabel {text:(_activeVehicle && _activeVehicle.battery.BMS_remaining.value != -1) ? (_activeVehicle.battery.BMS_remaining.valueString + " " + "min") : "N/A" }
